...
The schematic design and verification of the Clock Generator and UART Controller has been performed by an UVM-based testbench architecture using Siemens Questa Sim 10.7 Simulator.
